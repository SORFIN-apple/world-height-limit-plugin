# World Height Limit 1.20.0-1.20.4

Paper plugin for `1.20.0` through `1.20.4` that removes the default top build limit by generating a version-aware datapack in each world save folder.
