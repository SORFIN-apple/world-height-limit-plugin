...
Expand world height on Bukkit, Spigot, Paper, Purpur, and Folia 1.20.5-1.20.6 while keeping the normal vanilla height limit for regular players.

## Full Description

World Height Limit is a Bukkit/Spigot/Paper/Purpur/Folia plugin for 1.20.5-1.20.6 that increases world build height by generating a version-aware datapack in the world save folder.
